...
class StartScene extends Phaser.Scene {
  ...
  preload () {
    ...
    this.load.image('Frame18', 'assets/IntroScenes/spr_IntroScene19.png')
    this.load.image('Frame19', 'assets/IntroScenes/spr_IntroScene20.png')
    this.load.image('Frame20', 'assets/IntroScenes/spr_IntroScene21.png')

    this.load.image('Frame21', 'assets/IntroScenes/spr_IntroScene22.png')
    this.load.image('Frame22', 'assets/IntroScenes/spr_IntroScene23.png')
    this.load.image('Frame23', 'assets/IntroScenes/spr_IntroScene24.png')
    this.load.image('Frame24', 'assets/IntroScenes/spr_IntroScene25.png')
    this.load.image('Frame25', 'assets/IntroScenes/spr_IntroScene26.png')
    this.load.image('Frame26', 'assets/IntroScenes/spr_IntroScene27.png')
    this.load.image('Frame27', 'assets/IntroScenes/spr_IntroScene28.png')
    this.load.image('Frame28', 'assets/IntroScenes/spr_IntroScene29.png')
    this.load.image('Frame29', 'assets/IntroScenes/spr_IntroScene30.png')
    this.load.image('Frame30', 'assets/IntroScenes/spr_IntroScene31.png')

    this.load.image('Frame31', 'assets/IntroScenes/spr_IntroScene32.png')
    this.load.image('Frame32', 'assets/IntroScenes/spr_IntroScene33.png')
    this.load.image('Frame33', 'assets/IntroScenes/spr_IntroScene34.png')
    this.load.image('Frame34', 'assets/IntroScenes/spr_IntroScene35.png')
    this.load.image('Frame35', 'assets/IntroScenes/spr_IntroScene36.png')
    this.load.image('Frame36', 'assets/IntroScenes/spr_IntroScene37.png')
    this.load.image('Frame37', 'assets/IntroScenes/spr_IntroScene38.png')
    this.load.image('Frame38', 'assets/IntroScenes/spr_IntroScene39.png')
    this.load.image('Frame39', 'assets/IntroScenes/spr_IntroScene40.png')
