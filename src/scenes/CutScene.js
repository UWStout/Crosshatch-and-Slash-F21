...
class CutScene extends Phaser.Scene {
  ...
  create () {
    ...
    this.load.image('musicButton', 'assets/sprites/Buttons/spr_UI_buttonMusic.png')
    this.load.image('musicButtonIcon', 'assets/sprites/Buttons/spr_UI_buttonMusicIcon.png')
